    ...
    <div className>
      ...
      <div className="container">
        <div>
          ...
          <p className="title2">
            Az AssistedPro az első magyar vagyoni tanácsadó vállalatok egyike,
            1988-ben Szegeden alapították. Azóta törekszünk arra, hogy ügyfeleink
            számára magas színvonalú pénzügyi tanácsadást nyújtsunk.
          </p>{" "}
        </div>{" "}
        <div className="row">
